...
#'
fit_mt_susie <- function(x, y, levels = 15L, max_iter = 100L, min_iter = 5L, tol = 1e-8, prior_var = 100.0) {
    .Call('_mtSusie_fit_mt_susie', PACKAGE = 'mtSusie', x, y, levels, max_iter, min_iter, tol, prior_var)
}
