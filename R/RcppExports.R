...
fit_mt_interaction_susie <- function(x, y, w, levels_per_inter = 3L, max_iter = 100L, min_iter = 5L, coverage = .9, tol = 1e-8, prior_var = 100.0, lodds_cutoff = 0, min_pip_cutoff = NULL, full_stat = TRUE) {
