...
Rcpp::List fit_mt_interaction_susie(const Rcpp::NumericMatrix x, const Rcpp::NumericMatrix y, const Rcpp::NumericMatrix w, const std::size_t levels_per_wx, const std::size_t levels_per_w, const std::size_t levels_per_x, const std::size_t max_iter, const std::size_t min_iter, const double coverage, const double tol, const double prior_var, Rcpp::Nullable<double> min_pip_cutoff, const bool full_stat, const bool update_prior, const bool do_hard_selection, const double hard_lodds_cutoff);
RcppExport SEXP _mtSusie_fit_mt_interaction_susie(SEXP xSEXP, SEXP ySEXP, SEXP wSEXP, SEXP levels_per_wxSEXP, SEXP levels_per_wSEXP, SEXP levels_per_xSEXP, SEXP max_iterSEXP, SEXP min_iterSEXP, SEXP coverageSEXP, SEXP tolSEXP, SEXP prior_varSEXP, SEXP min_pip_cutoffSEXP, SEXP full_statSEXP, SEXP update_priorSEXP, SEXP do_hard_selectionSEXP, SEXP hard_lodds_cutoffSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(fit_mt_interaction_susie(x, y, w, levels_per_wx, levels_per_w, levels_per_x, max_iter, min_iter, coverage, tol, prior_var, min_pip_cutoff, full_stat, update_prior, do_hard_selection, hard_lodds_cutoff));
...
static const R_CallMethodDef CallEntries[] = {
    {"_mtSusie_fit_mt_interaction_susie", (DL_FUNC) &_mtSusie_fit_mt_interaction_susie, 16},
